...
\todo{what follows shouldn't be a remark. what should it be?}
...
\begin{example}[K-Theory Saga: The Ring $L_r$]\label{k-thy-Lr}
	...
	We note that this is in accordance with the algebro-geometric point of view from \ref{alg-geo-Lr}, as the this is of rank $p^r$ over $\ZZ_p$, and the points are isomorphic to the group of roots of unity of order $p^r$.
