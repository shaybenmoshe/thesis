...
\begin{remark}[Algebro-geometric interpretation of $L_r$]\label{alg-geo-Lr}
	...
	Since $\Gamma_U$ is of height $n$, the leading term of the $p^r$-series, has power $p^r$, which shows that the number of points in $\fG\left[p^r\right]$ is $p^r$, so as a group it is just $\ZZ/p^r$. \todo{right?}
