...
\begin{theorem}[{\cite[Theorem C]{HKR}}]\label{theorem-c}
	...
	is an isomorphism.
	Moreover, all of these statements hold when $L$ is replaced with $L_r$, for $r \geq r_0$.
\end{theorem}
...
Recall that we have already proved the third part, and we are not going to prove the first.
...
\begin{proof}
	...
	We claim that if such a triple exists, i.e. the fixed points are not empty, the necessarily $g^{-1}. \alpha \in H_{n,p}$.
...
\begin{proof}[Proof (of the second part of \ref{theorem-c})]
