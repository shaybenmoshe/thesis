\section{Elliptic Curves}\label{sec:ell}
...
We will display this along with the Macaulay2 code, that carries out the computation.
...
We will use in the code matrices (rather then other data types which store a list of values), as Macaulay2 has the best support for matrices.
...
Knowing the ranks will be useful later on.
