...
\begin{theorem}[Landweber Exact Functor Theorem (LEFT) \todo{reference}]\label{LEFT}
...
We can define the formal group law $u \Gamma_U \left(x, y\right) = u^{-1} \Gamma_U \left(u y, u z\right)$, which is of degree $-2$, thus we get a map $L \to \Wkuiu$.
